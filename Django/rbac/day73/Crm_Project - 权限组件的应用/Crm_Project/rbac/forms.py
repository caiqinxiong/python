...
MENU_CHOICES = [[i[0], mark_safe(i[1])] for i in
...
class MenuForm(forms.ModelForm):
    class Meta:
        model = models.Menu
        fields = ['title', 'wight', 'icon']

        widgets = {
            'title': forms.TextInput(attrs={'class': 'form-control'}),
            'wight': forms.NumberInput(attrs={'class': 'form-control'}),
            'icon': forms.RadioSelect(choices=MENU_CHOICES)
        }
