...
class PricePolicy(models.Model):
    ...
    project_num = models.PositiveIntegerField(verbose_name='创建项目个数上限')
    project_member = models.PositiveIntegerField(verbose_name='项目成员上限')
    project_space = models.PositiveIntegerField(verbose_name='每个项目的空间')
    each_file_size = models.PositiveIntegerField(verbose_name='单文件限制')
...
class ProjectUser(models.Model):
    ...
    user = models.ForeignKey(to='UserInfo', verbose_name='参与者')
    star = models.BooleanField(verbose_name='星标',default=False)
