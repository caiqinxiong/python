...
class DeployTask(models.Model):
    ...
    before_download_script = models.TextField(verbose_name='下载前', null=True, blank=True)
    after_download_script = models.TextField(verbose_name='下载后', null=True, blank=True)
    before_deploy_script = models.TextField(verbose_name='发布前', null=True, blank=True)
    after_deploy_script = models.TextField(verbose_name='发布后', null=True, blank=True)
